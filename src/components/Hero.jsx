  ...
  return (
    <section className="flex flex-col lg:flex-row min-h-screen gap-8 justify-center items-center p-4 lg:p-12 pt-32 bg-photo text-white">
      <div className="flex flex-col gap-8 justify-center items-start flex-1">
        ...
        <p className="text-xl lg:text-2xl lg:w-2/3">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Adipisci officiis eius nesciunt totam praesentium magnam ullam aspernatur nostrum iure quasi.</p>
      ...
      <div className="flex flex-col gap-8 flex-1 lg:mt-48 py-12 lg:py-0">
        ...
        <p className="text-xl lg:w-3/4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quasi fugit saepe sequi tenetur voluptatem hic architecto voluptate neque autem quo?</p>
      </div>
    </section>
  )
}
