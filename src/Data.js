...
const Data = [
  ...
  },
  {
    ...
    place: 'Bydgoszcz, Polska',
  },
  {
    title: 'Artystyczna Przyszłość',
    link: 'artystyczna-przyszłosc',
    photo: [lato1],
    description: '"Artystyczna Przyszłość" to program mający na celu rozwijanie talentów artystycznych dzieci z mniejszych miejscowości. W listopadzie 2023 roku, planujemy zorganizować kursy artystyczne i dostarczyć niezbędne materiały dla dzieci w Lublinie. Naszym celem jest nie tylko rozwijanie umiejętności plastycznych, muzycznych czy teatralnych, ale także inspiracja do kreatywnego myślenia i wyrażania siebie poprzez sztukę. Chcemy, aby każde dziecko miało szansę odkrycia swojego artystycznego potencjału i czerpało radość ze sztuki.',
    shortDescription: 'Malowanie, rzeźba, muzyka - dajmy dzieciom szansę odkrycia i rozwijania swojego artystycznego potencjału.',
    date: new Date('2023-11-23'),
    place: 'Lublin, Polska',
  },
  {
    title: 'Wesoła Wigilia dla Wszystkich',
    link: 'wesoła-wigilia-dla-wszystkich',
    photo: [lato1],
    description: '"Wesoła Wigilia dla Wszystkich" to inicjatywa mająca na celu zapewnienie radości i ciepła w czasie świąt Bożego Narodzenia dla rodzin potrzebujących. W grudniu 2023 roku, planujemy zorganizować wigilijne posiłki, dostarczyć prezenty dla dzieci i stworzyć świąteczną atmosferę w Gdańsku. Chcemy, aby każde dziecko doświadczyło magii świąt, niezależnie od sytuacji materialnej jego rodziny. Ciepłe posiłki, upominki i uśmiech - to nasz prezent dla dzieci w okresie świątecznym.',
    shortDescription: 'Niech żaden stół nie pozostanie pusty - razem sprawmy, aby każde dziecko miało wesołe Święta.',
